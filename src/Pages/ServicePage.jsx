          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div className="bg-white rounded-lg shadow-lg w-full md:w-1/3">
              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  <button className="bg-deepBlue text-white px-4 py-2 rounded hover:bg-purple-700" onClick={() => handleSelectedService("My Services (Basic)")}>
                    Choose Basic
                  </button>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg w-full md:w-1/3">
              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  <button className="bg-deepBlue text-white px-4 py-2 rounded hover:bg-purple-700" onClick={() => handleSelectedService("My Services (Premium)")}>
                    Choose Premium
                  </button>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg w-full md:w-1/3">
              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  <button className="bg-deepBlue text-white px-4 py-2 rounded hover:bg-purple-700" onClick={() => handleSelectedService("My Services (Elite)")}>
                    Choose Elite
                  </button>
                </div>
              </div>
