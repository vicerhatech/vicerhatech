    ...
    <footer className="bg-gray-900 text-white py-10">
      <div className="container mx-auto px-6 flex flex-wrap justify-between">
        <div className="w-full md:w-1/4 mb-6 md:mb-0">
          ...
          <p>
            At VicerhaTech, i merge innovation with simplicity to deliver
            tech-driven solutions, empowering individuals and businesses
            worldwide. Through insightful,  cutting-edge tools, and expert
            guidance, i inspire my audience to thrive in the digital era.
          </p>
        </div>
        ...
        <div className="w-full md:w-1/4 mb-6 md:mb-0">
          ...
          <p className="mb-4">
            Subscribe to my newsletter for the latest updates, tips, and
            exclusive offers.
          </p>
          <form className="flex">
            <input
